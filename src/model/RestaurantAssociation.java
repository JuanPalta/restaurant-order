...
public class RestaurantAssociation {
	...
	/**
	 * Constructor of class RestaurantAssociation pre: pos: create a
	 * RestaurantAssociation instance
	 * 
	...
	/**
	 * get Restaurants pre: pos: get the list of the restaurants
	 * 
	...
	/**
	 * Register a restaurant pre: pos: register succesfuly a restaurant
	 * 
	 * @throws IOException            IOException
	 * @throws ClassNotFoundException ClassNotFoundException
	 * @param nit       the nit
	...
	/**
	 * Save the restaurants pre: pos: save all the restaurants
	 * 
	 * @throws IOException            IOException
	 * @throws ClassNotFoundException ClassNotFoundException
	 */
	...
	/**
	 * Import the restaurants pre: the filename need exists pos: import the
	 * restaurants
	 * 
	 ...
	 * @throws FileNotFoundException  FileNotFoundException
	 */
	public void importRestaurants(String filename, String separator)
	...
	/**
	 * Show the restaurants pre: pos : show the restaurants
	 */
	public void showRestaurants() {

		for (int i = 0; i < restaurants.size(); i++) {

			System.out.println((i + 1) + "." + restaurants.get(i).getName() + " " + restaurants.get(i).getNameAdmin()
					+ " " + restaurants.get(i).getNit());
		}
	}

	/**
	 * Searh the restaurant pre: pos: return null if the restaurant doesnt exist,
	 * retur the restaurant if this exists
	 * 
	 * @param nit the nit
	 * @return Restaurant r
